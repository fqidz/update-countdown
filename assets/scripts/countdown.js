...
document.addEventListener("DOMContentLoaded", (_event) => {
    ...
    websocket.addEventListener("open", () => { refresh_button.enable() });

    websocket.addEventListener("close", () => { refresh_button.disable() });

    websocket.addEventListener("updatedatetime", (event) => {
        const datetime = /** @type {Date} */(/** @type {CustomEvent} */(event).detail);
    ...
    countdown_elem.addEventListener("click", () => { countdown_display.cycleState() });
    datetime_elem.addEventListener("click", () => { datetime_display.cycleState() });
